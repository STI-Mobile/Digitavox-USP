...
public partial class ExercisesStatisticsView : ContentPage, IKeyboardInputHandler
{
    private ExercisesStatisticsViewModel ViewModel => (ExercisesStatisticsViewModel)BindingContext;
